...
namespace Week11_1 {
    ...
    public partial class studentsDataSet : global::System.Data.DataSet {
        ...
        public partial class studentsDataTable : global::System.Data.TypedTableBase<studentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentsRow AddstudentsRow(string first_name, string last_name, string exam, string grade, int student_id) {
        ...
        public partial class studentsRow : global::System.Data.DataRow {
            ...
            public string exam {
                get {
                    return ((string)(this[this.tablestudents.examColumn]));
                }
                set {
                    this[this.tablestudents.examColumn] = value;
                }
            }
...
namespace Week11_1.studentsDataSetTableAdapters {
    ...
    public partial class studentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[students] WHERE (([id] = @Original_id) AND ([first_name] = @Or" +
                "iginal_first_name) AND ([last_name] = @Original_last_name) AND ([exam] = @Origin" +
                "al_exam) AND ([grade] = @Original_grade) AND ([student_id] = @Original_student_i" +
                "d))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_exam", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "exam", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[students] ([first_name], [last_name], [exam], [grade], [studen" +
                "t_id]) VALUES (@first_name, @last_name, @exam, @grade, @student_id);\r\nSELECT id," +
                " first_name, last_name, exam, grade, student_id FROM students WHERE (id = SCOPE_" +
                "IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[students] SET [first_name] = @first_name, [last_name] = @last_name, [exam] = @exam, [grade] = @grade, [student_id] = @student_id WHERE (([id] = @Original_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([exam] = @Original_exam) AND ([grade] = @Original_grade) AND ([student_id] = @Original_student_id));
SELECT id, first_name, last_name, exam, grade, student_id FROM students WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@exam", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "exam", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_exam", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "exam", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Week11_1.Properties.Settings.Default.studentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, first_name, last_name, exam, grade, student_id FROM dbo.students";
        ...
        public virtual int Delete(int Original_id, string Original_first_name, string Original_last_name, string Original_exam, string Original_grade, int Original_student_id) {
            ...
            if ((Original_exam == null)) {
                throw new global::System.ArgumentNullException("Original_exam");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_exam));
            }
            ...
            this.Adapter.DeleteCommand.Parameters[5].Value = ((int)(Original_student_id));
        ...
        public virtual int Insert(string first_name, string last_name, string exam, string grade, int student_id) {
            if ((first_name == null)) {
            ...
            if ((exam == null)) {
                throw new global::System.ArgumentNullException("exam");
            }
            else {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(student_id));
        ...
        public virtual int Update(string first_name, string last_name, string exam, string grade, int student_id, int Original_id, string Original_first_name, string Original_last_name, string Original_exam, string Original_grade, int Original_student_id, int id) {
            if ((first_name == null)) {
                throw new global::System.ArgumentNullException("first_name");
            }
            else {
            ...
            if ((exam == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(exam));
            }
            if ((grade == null)) {
                throw new global::System.ArgumentNullException("grade");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(student_id));
            ...
            if ((Original_exam == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_exam));
            }
            if ((Original_grade == null)) {
                throw new global::System.ArgumentNullException("Original_grade");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string first_name, string last_name, string exam, string grade, int student_id, int Original_id, string Original_first_name, string Original_last_name, string Original_exam, string Original_grade, int Original_student_id) {
            return this.Update(first_name, last_name, exam, grade, student_id, Original_id, Original_first_name, Original_last_name, Original_exam, Original_grade, Original_student_id, Original_id);
        }
    }
